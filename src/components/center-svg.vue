    ...
    >
      <defs>
        ...
        >
          ...
          <feFlood result="flood" flood-color="blue" flood-opacity="0.9" />
      ...
      <g id="dongxiao1">
        ...
        <image
          ...
          width="539"
          height="419"
          xlink:href="@/assets/images/center/center.png"
        />
        <g id="right">
          <g id="组_380" data-name="组 380">
            ...
            <template v-for="item in [1, 2, 3]" :key="item">
              <circle cx="0" cy="0" r="3" class="dots-blue">
                <animateMotion
                  dur="6s"
                  begin="-3s"
            ...
            <template v-for="item in [1, 2, 3]" :key="item">
              <circle cx="0" cy="0" r="3" class="dots-orange">
                <animateMotion
                  dur="6s"
                  begin="-3s"
                  repeatCount="indefinite"
...
<style scoped>
  ...
  #icon_hot_zhuhai {
    animation: cityAnima 2s ease-in infinite;
  }
  @keyframes cityAnima {
    0%, 100% {
  ...
  .cls-13,
  .cls-14 {
    animation: lightAnima 3s linear infinite;
  }
  @keyframes lightAnima {
    0%, 100% {
      opacity: 0;
    }
    50% {
